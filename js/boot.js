var DuckbumpGame = {
  ...
  COOKED_DEATH_DELAY: Phaser.Timer.SECOND * 5,
  COOKED_FALL_DURATION: Phaser.Timer.SECOND * 2,

  SPAWN_ENEMY_DELAY: Phaser.Timer.SECOND,
  SPAWN_SHOOTER_DELAY: Phaser.Timer.SECOND * 3,

  SHOT_DELAY: Phaser.Timer.SECOND * .25,
...
DuckbumpGame.Boot = function (game) {

};

DuckbumpGame.Boot.prototype = {
